...
// ベジエ曲面の制御点へのインデックス
typedef std::array<int, 16> Bezier16IndicesArray;

constexpr std::array<Bezier16IndicesArray, 32> g_indices = {{
...
constexpr std::array<std::array<float, 3>, 306> g_vertices = {{
    {{1.4,0.0,2.4}},
    {{1.4,-0.784,2.4}},
    {{0.784,-1.4,2.4}},
    {{0.0,-1.4,2.4}},
